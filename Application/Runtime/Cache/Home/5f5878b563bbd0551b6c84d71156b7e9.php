...
<body>
	<div id="top">
		...
		<div id="search" style="float: left;margin-left: 50px;margin-top: 18px;background-color: #E6E6E6;padding-left: 10px;">
			<input type="text" class="input-text" style="background-color: #E6E6E6;width: 180px;border: none;" name="keyword" value="" placeholder="请输入您想要搜索的内容" />
			<input type="button" class="btn radius" value="搜索" style="border: none; background-color: #E6E6E6" onclick="search()" />
		</div>
		<div id="info" style="float: left;font-size: 28px;margin-top: 14px;margin-left: 140px;">
			<i class="Hui-iconfont">
				<a href="javascript:void(0);" onClick="member_show('个人信息','id=<?php echo ($user["id"]); ?>&role=<?php echo ($user["role"]); ?>','0','0')" title="<?php echo ($user["name"]); ?>">&#xe625;</a>
			</i>
			&nbsp;&nbsp;
	...
	<div id="right">
		...
		<div id="right3">
			<p style="margin-top: 10px;margin-left: 15px">
				...
				<input type="text" class="input-text" style="float: right;width: 25px;height: 25px;margin-right: 20px;margin-top: 2px;background-color: #E6E6E6;border: none;text-align: center;" value="0" />
...
<script type="text/javascript">
	function member_show(title,url,w,h) {
		...
		if(account) {
			title = "个人中心";
			url = "<?php echo U('User/index');?>?"+url;
			w = document.body.clientWidth*0.95;
			h = document.body.clientHeight*0.85;
