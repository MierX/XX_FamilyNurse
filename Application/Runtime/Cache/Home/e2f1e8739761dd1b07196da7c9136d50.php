      ...
      <form class="form form-horizontal" action="<?php echo U('register');?>" method="post" onsubmit="return registerNow()">
        ...
        <div class="row cl">
          ...
          <div class="formControls col-xs-8">
            <label>
              <input type="text" name="account" class="input-text size-L" value="" placeholder="请设置你的账号(不少于6位)" onfocusout="checkValue(this.name,this.value)" />
        ...
        <div class="row cl">
          ...
          <div class="formControls col-xs-8">
            <label>
              <input type="text" name="name" class="input-text size-L" value="" placeholder="请输入你的真实姓名" onfocusout="checkValue(this.name,this.value)" />
        ...
        <div class="row cl">
          ...
          <div class="formControls col-xs-8" style="margin-top: 5px;">
            <label style="font-size: 20px">
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;女：<input type="radio" name="sex" class="radio-box size-L" value="0" />
            </label>
          </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
          ...
          <div class="formControls col-xs-8">
            <label>
              <input type="number" name="phone" class="input-text size-L" value="" placeholder="请输入联系电话" onfocusout="checkValue(this.name,this.value)" />
        ...
        <div class="row cl">
          ...
          <div class="formControls col-xs-8">
            <label>
              <input type="number" name="card" class="input-text size-L" value="" placeholder="请输入身份证号" onfocusout="checkValue(this.name,this.value)" />
